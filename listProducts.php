    ...
    <div class="mt-3"> 
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-box-seam"></i> Productos y Categorías</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/products/products_categories.php"); ?>
            <div class="row">
...
<script>
    $(document).ready(function() {
        $('#link-productos').addClass('pagina-activa');
    });
</script>
