...
<head>
    ...
    <title>Poder Down</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet">
    <link rel="stylesheet" href="css/login1.css?v=2.2">
    <link rel="icon" href="img/pd_icono.png" type="image/x-icon">
    <style>
    ...
    <div class="login-container">
        <div class="login-sidebar" style="position: relative;">
            <div class="login-logo">
                <img src="./img/logos/pd_logo_vert_blanco.png" alt="Logo Porder Down" class="img-fluid pb-2" style="width: 90%; max-width: 400px;">
            </div>

            <p class="login-text text-white">Inicia sesión con tus credenciales para acceder al sistema</p>

            <br>
            <small class="text-white d-block text-center" style="position: absolute; bottom: 20px; left: 0; width: 100%;">
